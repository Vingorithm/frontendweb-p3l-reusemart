...
const DetailBarang = () => {
  ...
  // buat fetch data barang, penitip, dan diskusi berdasarkan id
  useEffect(() => {
  ...
  // dapetin data user yang lagi login
  ...
  // function buat format harga jadi rupiah
  ...
  // function buat ngerender bintang penitip
  ...
  // fetch data diskusi berdasarkan id_barang
